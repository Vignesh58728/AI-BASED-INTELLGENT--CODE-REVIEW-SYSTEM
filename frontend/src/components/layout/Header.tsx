                  ...
                  <div className="flex items-center gap-3">
                      <Link to="/notifications">
                        <Button variant="ghost" size="icon" className="relative h-10 w-10 text-black hover:bg-zinc-100 rounded-full">
                           ...
                           {unreadCount > 0 && (
                              <span className="absolute -top-1 -right-1 flex h-4 min-w-[16px] items-center justify-center rounded-full bg-[#2192ff] px-1 text-[10px] font-bold text-white ring-2 ring-white">
