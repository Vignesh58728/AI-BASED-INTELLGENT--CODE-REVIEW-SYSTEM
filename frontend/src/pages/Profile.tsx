...
export function Profile() {
 ...
 <a className="flex items-center gap-3 p-3 bg-slate-100 text-slate-900 rounded-lg shadow-sm font-semibold hover:translate-x-1 transition-all duration-200" href="/profile">
