   ...
   return (
      <div className="space-y-8 container mx-auto py-12 px-6">
         <div className="flex justify-between items-end border-b border-zinc-100 pb-8">
            <div>
               <h1 className="text-4xl font-bold tracking-tight text-black mb-3 text-emerald-600">Algorithms</h1>
               <p className="text-black text-lg max-w-2xl">Learn and implement essential competitive algorithms with AI assistance.</p>
            </div>
            <div className="bg-emerald-50 px-6 py-3 rounded-2xl border border-emerald-100">
               <span className="text-sm font-bold text-emerald-600 uppercase tracking-widest">Compiler Engine Ready</span>
            </div>
         </div>
         ...
         {isLoading ? (
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
               ...
               <div
                  ...
                  className="group relative h-48 rounded-[32px] overflow-hidden cursor-pointer border-2 border-dashed border-emerald-200 hover:border-emerald-500/50 transition-all duration-500 flex flex-col items-center justify-center gap-4 bg-emerald-50/20 hover:bg-emerald-50 shadow-sm hover:shadow-xl"
               >
                  <div className="w-14 h-14 rounded-2xl bg-emerald-600 text-black flex items-center justify-center group-hover:scale-110 transition-transform duration-500 shadow-lg shadow-emerald-500/20">
                     <svg viewBox="0 0 24 24" className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth="2.5">
                        <path d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" strokeLinecap="round" strokeLinejoin="round" />
                     </svg>
                  </div>
                  <div className="text-center">
                     <p className="text-sm font-black uppercase tracking-[0.2em] text-emerald-900 mb-1">Algorithm Playground</p>
                     <p className="text-[11px] text-emerald-600/60 font-medium italic">General Compile API Mode</p>
                  </div>
               </div>
