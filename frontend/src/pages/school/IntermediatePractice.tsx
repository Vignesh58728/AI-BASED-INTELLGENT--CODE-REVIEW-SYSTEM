...
export function IntermediatePractice() {
   ...
   const completedIds = new Set(progress.completedProblemIds);
      ...
      <div className="min-h-screen bg-white">
         <div className="container mx-auto px-4 py-8 max-w-7xl">
            ...
            <div className="mb-8 flex items-center gap-3">
               ...
               <div>
                  <h1 className="text-3xl font-bold tracking-tight text-black">Intermediate Practice</h1>
            ...
            <div className="flex items-center justify-between mb-4">
               <p className="text-sm text-black">
                  Showing <span className="text-black font-semibold">{filtered.length}</span> programs
               </p>
            ...
            {filtered.length > 0 ? (
               ...
               <div className="flex flex-col items-center justify-center py-24 text-center">
                  ...
                  <h3 className="text-black font-semibold mb-1">No programs found</h3>
